...
def mcmc_abc_algorithm(N, epsilon, observed_data, n_spins, step_size=0.1):
    ...
    for t in range(1, N + 1):
        ...
        z_proposed = ising_model_simulation(theta_proposed[0], theta_proposed[1], n_spins)
        ...
        u = np.random.rand()
        likelihood_ratio = 1  # Here we assume the prior is uniform and the proposal is symmetric
